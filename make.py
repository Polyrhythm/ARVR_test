...
def get_lib_files(filedir, inexcl):
    ...
    files += rglob(os.path.join(filedir, "Assets/Vuforia"), "*.cs", excl)
    files += rglob(os.path.join(filedir, "Assets/GoogleVR"), "*.cs", excl)
    return files
